...
namespace Phase3_PracticeProj_sec6_WEbapi_StudentMarks.Controllers
{
    public class StudentMarksWebAPIController : ApiController
    {
        ...
        // DELETE: api/StudentMarksWebAPI/5
        [ResponseType(typeof(StudentMark))]
